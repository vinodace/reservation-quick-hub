                      ...
                      <div class="row">
                        <div class="col-sm-6 col-md-6 pe-md-0">
                          <div class="form-group" id="citySection">
                            ...
                            <input type="text" class="filter-field from_oneway1 field-right-radius-0" name="origin" placeholder="From" value="<?= $origin ?>" required>
                          </div> 
                        </div>
                        <div class="col-sm-6 col-md-6 px-md-0">
                          <div class="form-group" id="citySection">
                            <label class="filter-lbl">Going To</label>
                            <input type="text" class="filter-field to_oneway1 field-radius-0" name="destination" placeholder="To" value="<?= $destination ?>" required>
                          </div>
                        </div>    
                      </div>
                    </div>
      ...
      <div class="col-md-9">
        <?php if (isset($results["data"])): ?>
            <?php foreach ($results["data"] as $offer): ?>
                <?php foreach ($offer["itineraries"] as $itinerary): ?>
                    <?php foreach ($itinerary["segments"] as $index => $seg): ?>
                        <?php
                            ...
                            $departureTime = date("h:i A", strtotime($seg["departure"]["at"]));
                            ...
                            $departureDateTime = strtotime($seg["departure"]["at"]);
                            $arrivalDateTime   = strtotime($seg["arrival"]["at"]);
                            $durationInMin     = round(($arrivalDateTime - $departureDateTime) / 60);
                              ...
                              <div class="row">
                                <div class="col-auto">
                                  <div class="d-flex align-items-center gap-3 mb-2 mb-md-0">
                                    <img src="<?= $logoUrl ?>" class="flight-result-logo" width="50" alt="<?= $airlineCode ?>">
                                    <p class="flight-logo-name d-block d-md-none mb-0"><?= $airlineName ?></p>
                                  </div>  
                                </div>
                                ...
                                <div class="col-12 col-md">
                                  <div class="row text-center">
                                    <div class="col-4">
                                      <h4 class="flight-time"><?= $departureTime ?></h4>
                                      <p class="flight-location text-uppercase mb-0"><?= $departureAirport ?></p>
                                    </div>
                                    <div class="col-4">
                                      <div class="flight-result-duration">
                                        ...
                                        <?php if ($index < count($itinerary["segments"]) - 1): ?>
                                          <?php
                                            $nextDep = $itinerary["segments"][$index+1]["departure"]["at"];
                                            $layoverMins = round((strtotime($nextDep) - $arrivalDateTime) / 60);
                                            $layoverHrs = floor($layoverMins / 60);
                                            $layoverMin = $layoverMins % 60;
                                            echo "<small class='text-muted'>{$layoverHrs}h {$layoverMin}m Layover</small>";
                                          ?>
                                        <?php endif; ?>
                                      </div>
                                    </div>
                                    <div class="col-4">
                                      <h4 class="flight-time"><?= $arrivalTime ?></h4>
                                      <p class="flight-location text-uppercase mb-0"><?= $arrivalAirport ?></p>
                                    </div>
                                  </div>
                                </div>

                                <div class="col-sm-12 d-none d-md-block mt-2">
                                  <p class="flight-logo-name"><?= $airlineName ?></p>
                                </div>
                              </div>  
                            </div>
                            ...
                            <div class="col-md-3">
                              <div class="flight-result-price-area">
                                <div>
                                  ...
                                  <p class="wrap-prgh text-muted"><?= ucfirst($offer["type"]) ?></p>
                                </div>  
