                      ...
                      <div class="row">
                        <div class="col-sm-6 col-md-6 pe-md-0">
                          <div class="form-group" id="citySection">
                            ...
                            <input type="text" class="filter-field from_oneway1 field-right-radius-0" name="origin" placeholder="From" required>
                          </div> 
                        </div>
                        <div class="col-sm-6 col-md-6 px-md-0">
                          <div class="form-group" id="citySection">
                            <label class="filter-lbl">Going To</label>
                            <input type="text" class="filter-field to_oneway1 field-radius-0" name="destination" placeholder="To" required>
                          </div>
                        </div>    
                      </div>
                    </div>
