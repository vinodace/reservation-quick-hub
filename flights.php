      ...
      <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="flight-result-price-area">
                <div>
                  <a href="ua-LAS-CDG.php" class="flight-price">$1013</a>
                  <p class="wrap-prgh text-muted">Round-trip</p>
                </div>  
                <a href="ua-LAS-CDG.php" class="wrap-btn bg-info mt-0">Select</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flight-result-box">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="flight-result-price-area">
                <div>
                  <a href="da-LAS-CDG.php" class="flight-price">$1013</a>
                  <p class="wrap-prgh text-muted">Round-trip</p>
                </div>  
                <a href="da-LAS-CDG.php" class="wrap-btn bg-info mt-0">Select</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flight-result-box">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="flight-result-price-area">
                <div>
                  <a href="va-LAS-CDG.php" class="flight-price">$1010</a>
                  <p class="wrap-prgh text-muted">Round-trip</p>
                </div>  
                <a href="va-LAS-CDG.php" class="wrap-btn bg-info mt-0">Select</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flight-result-box">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="flight-result-price-area">
                <a href="da-JFK-WLG.php" class="flight-price">$704</a>
                <a href="da-JFK-WLG.php" class="wrap-btn bg-info mt-0">Select</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flight-result-box">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="flight-result-price-area">
                <a href="fa-JFK-WLG.php" class="flight-price">$667</a>
                <a href="fa-JFK-WLG.php" class="wrap-btn bg-info mt-0">Select</a>
              </div>
            </div>
          </div>
        </div>
